...
**JWT Аутентификация** — реализована система аутентификации с access и refresh токенами. Access token короткоживущий (15 минут), refresh token долгоживущий (30 дней) и хранится в БД. Используется OAuth2 схема для защиты endpoints. Пароли хешируются через bcrypt.
