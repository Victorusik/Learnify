...
4. **Адаптивное обучение** — алгоритм spaced repetition с интервалами 1, 7, 16, 35 дней
5. **Типобезопасность** — TypeScript на frontend, Pydantic на backend для валидации данных
6. **Контейнеризация** — полная Docker-изация для простого деплоя и разработки
7. **Миграции БД** — версионирование схемы через Alembic для безопасных обновлений
